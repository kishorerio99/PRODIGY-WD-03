...
function App() {
  ...
  const checkWinner = () => {
    //check row winner
    if( matrix[0][0] && matrix[0][0] === matrix[0][1] && 
      matrix[0][0] === matrix[0][2]) {
         setWinner(matrix[0][0] + 'is the winner');
    }
    if(matrix[1][0] && matrix[1][0] === matrix[1][1] && 
      matrix[1][1] === matrix[1][2]) {
         setWinner(matrix[1][0] + 'is the winner');
    }
    if(matrix[2][0] && matrix[2][0] === matrix[2][1] && 
      matrix[2][1] === matrix[2][2]) {
         setWinner(matrix[2][0] + 'is the winner');
    }
    //check col 
    if( matrix[0][0] && matrix[0][0] === matrix[1][0] && 
      matrix[1][0] === matrix[2][0]) {
         setWinner(matrix[2][0] + 'is the winner');
    }
    if( matrix[0][1] && matrix[0][1] === matrix[1][1] && 
      matrix[1][1] === matrix[2][1]) {
         setWinner(matrix[2][1] + 'is the winner');
    }
    if( matrix[0][2] && matrix[0][2] === matrix[1][2] && 
